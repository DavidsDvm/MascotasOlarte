...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="../help/css/style_patient.css">
    ...
    <table class="table-crud table table-bordered">
      <thead class="thead-crud">
        <tr>
          ...
          <th scope="col">apellidoPaciente</th>
          <th scope="col">correoPaciente</th>
          <th scope="col">telefonoPaciente</th>
          <th scope="col">direccionPaciente</th>
          <th scope="col">fechaNacimiento</th>
          <th scope="col">estadoPaciente</th>
          <th scope="col">idUsuarioFK</th>
          <th scope="col"><button type="button" class="btn btn-success" onclick="location.href='add_patient.php'">Agregar Nuevo</button></th>
        </tr>
      </thead>
			<tbody>
        <?php
        require_once('../models/clsPaciente.php');
        $objeto=new Paciente();
        ...
        ?>
        <tr>
          <td class="crud-text-blue"><?php echo $fila['idPaciente']; ?></td>
          <td class="crud-text-green"><?php echo $fila['nombrePaciente']; ?></td>
          <td class="crud-text-blue"><?php echo $fila['apellidoPaciente']; ?></td>
          <td class="crud-text-green"><?php echo $fila['correoPaciente']; ?></td>
          <td class="crud-text-blue"><?php echo $fila['telefonoPaciente']; ?></td>
          <td class="crud-text-green"><?php echo $fila['direccionPaciente']; ?></td>
          <td class="crud-text-blue"><?php echo $fila['fechaNacimiento']; ?></td>
					<td class="crud-text-green"><?php echo $fila['estadoPaciente']; ?></td>
