...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="../help/css/style_medical_consultation.css">
			...
			<nav class="navbar navbar-expand-lg navbar-light">
				...
				<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
					...
					<ul class="nav nav-pills ml-auto">
						...
						<li class="nav-item">
							<a class="nav-link active" href="medical-consultation.php">Consulta Médica</a>
						</li>
						<li class="nav-item">
    ...
    <table class="table-crud table table-bordered">
      <thead class="thead-crud">
        <tr>
          ...
          <th scope="col">horaAtencion</th>
          <th scope="col">motivoConsulta</th>
          <th scope="col">enfermedad</th>
          <th scope="col">idHistoriafk</th>
          <th scope="col"><button type="button" class="btn btn-success" onclick="location.href='add_medical-consultation.php'">Agregar Nuevo</button></th>
        </tr>
      </thead>
			<tbody>
        <?php
        require_once('../models/clsConsultaMedica.php');
        $objeto=new ConsultaMedica();
        $filas=$objeto->consultarTodos();
        if ($filas !=null){
          foreach ($filas as $fila) {
        ?>
        <tr>
          <td class="crud-text-blue"><?php echo $fila['idConsulta']; ?></td>
          <td class="crud-text-green"><?php echo $fila['horaAtencion']; ?></td>
          <td class="crud-text-blue"><?php echo $fila['motivoConsulta']; ?></td>
          <td class="crud-text-green"><?php echo $fila['enfermedad']; ?></td>
          <td class="crud-text-blue"><?php echo $fila['idHistoriaFK']; ?></td>
          <td>
