...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="../help/css/style_exam.css">
  ...
  <body>
    ...
    <table class="table-crud table table-bordered">
      <thead class="thead-crud">
        <tr>
          <th scope="col">idExamen</th>
          <th scope="col">Valor</th>
          <th scope="col">fechaExamen</th>
          <th scope="col">tipoExamen</th>
          <th scope="col">idHistoriaFK</th>
          <th scope="col"><button type="button" class="btn btn-success" onclick="location.href='add_exam.php'">Agregar Nuevo</button></th>
        </tr>
      </thead>
			<tbody>
        <?php
        require_once('../models/clsExamen.php');
        $objeto=new Examen();
        ...
        ?>
        <tr>
          <td class="crud-text-blue"><?php echo $fila['idExamen']; ?></td>
          <td class="crud-text-green"><?php echo $fila['Valor']; ?></td>
          <td class="crud-text-blue"><?php echo $fila['fechaExamen']; ?></td>
          <td class="crud-text-green"><?php echo $fila['tipoExamen']; ?></td>
