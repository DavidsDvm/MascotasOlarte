...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="../help/css/style_medic.css">
			...
			<nav class="navbar navbar-expand-lg navbar-light">
				...
				<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
					...
					<ul class="nav nav-pills ml-auto">
						...
						<li class="nav-item">
							<a class="nav-link active" href="medic.php">Médico</a>
						</li>
						<li class="nav-item">
    ...
    <table class="table-crud table table-bordered">
      <thead class="thead-crud">
        <tr>
          ...
          <th scope="col">nombreMedico</th>
          <th scope="col">apellidoMedico</th>
          <th scope="col">telefonoMedico</th>
          <th scope="col">correoMedico</th>
          <th scope="col">tarjetaProfesional</th>
          <th scope="col">especialidadMedico</th>
          <th scope="col">estadoMedico</th>
          <th scope="col">idUsuarioFK</th>
          <th scope="col"><button type="button" class="btn btn-success" onclick="location.href='add_medic.php'">Agregar Nuevo</button></th>
        </tr>
      </thead>
			<tbody>
        <?php
        ...
        ?>
        <tr>
          <td class="crud-text-blue"><?php echo $fila['idMedico']; ?></td>
          <td class="crud-text-green"><?php echo $fila['nombreMedico']; ?></td>
          <td class="crud-text-blue"><?php echo $fila['apellidoMedico']; ?></td>
          <td class="crud-text-green"><?php echo $fila['telefonoMedico']; ?></td>
          <td class="crud-text-blue"><?php echo $fila['correoMedico']; ?></td>
          <td class="crud-text-green"><?php echo $fila['tarjetaProfesional']; ?></td>
          <td class="crud-text-blue"><?php echo $fila['especialidadMedico']; ?></td>
          <td class="crud-text-green"><?php echo $fila['estadoMedico']; ?></td>
          <td class="crud-text-blue"><?php echo $fila['idUsuarioFK']; ?></td>
          <td>
