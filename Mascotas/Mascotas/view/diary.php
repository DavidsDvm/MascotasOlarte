...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="../help/css/style_diary.css">
    ...
    <table class="table-crud table table-bordered">
      <thead class="thead-crud">
        <tr>
          ...
          <th scope="col">fechaAgenda</th>
          <th scope="col">horaAgenda</th>
          <th scope="col">Consultorio</th>
          <th scope="col">estadoAgenda</th>
          <th scope="col">idPacienteFK</th>
          <th scope="col">idMedicoFK</th>
          <th scope="col"><button type="button" class="btn btn-success" onclick="location.href='add_diary.php'">Agregar Nuevo</button></th>
        </tr>
      </thead>
			<tbody>
        <?php
        require_once('../models/clsAgenda.php');
        $objeto=new Agenda();
        ...
        ?>
        <tr>
          <td class="crud-text-blue"><?php echo $fila['idAgenda']; ?></td>
          <td class="crud-text-green"><?php echo $fila['fechaAgenda']; ?></td>
          <td class="crud-text-blue"><?php echo $fila['horaAgenda']; ?></td>
          <td class="crud-text-green"><?php echo $fila['Consultorio']; ?></td>
          <td class="crud-text-blue"><?php echo $fila['estadoAgenda']; ?></td>
          <td class="crud-text-green"><?php echo $fila['idPacienteFK']; ?></td>
          <td class="crud-text-blue"><?php echo $fila['idMedicoFK']; ?></td>
          <td>
