  ...
  <body>
    ...
    <header class="header">
      <nav class="navbar navbar-expand-lg navbar-light">
		...
		?>
		<form method="POST" action="../controllers/controlEditarMedico.php">
	    <div class="container-login100">
					...
					<span class="login100-form-sub-title p-b-37 mensaje-text-green">
						<?php
							if($mensaje=='errorclave'){
								echo "Hay un error en la contrasena";
								}else{
									if($mensaje=='editarok'){
	        ...
	        <div class="wrap-input100 validate-input m-b-20" data-validate="Digite el nombre del medico">
						<input maxlength="32" required class="input100" type="text" name="name-medic" placeholder="Digite el nombre del medico" value="<?php if ($mensaje=='correcto') {echo $nombre;}  ?>">
						<span class="focus-input100"></span>
					</div>
	        <div class="wrap-input100 validate-input m-b-20" data-validate="Digite el apellido del medico">
						<input maxlength="32" required class="input100" type="text" name="last-name-medic" placeholder="Digite el apellido del medico" value="<?php if ($mensaje=='correcto') {echo $apellido;}  ?>">
						<span class="focus-input100"></span>
					</div>
	        <div class="wrap-input100 validate-input m-b-20" data-validate="Digite el telefono del medico">
						<input maxlength="32" required
						 class="input100" type="number" name="phone-numer-medic" placeholder="Digite el telefono del medico" value="<?php if ($mensaje=='correcto') {echo $telefono;} ?>">
						<span class="focus-input100"></span>
					</div>
	        <div class="wrap-input100 validate-input m-b-20" data-validate="Digite el correo del medico">
						<input maxlength="32" required class="input100" type="email" name="email-medic" placeholder="Digite el correo del medico" value="<?php if ($mensaje=='correcto') {echo $correo;} ?>">
						<span class="focus-input100"></span>
					</div>
	        <div class="wrap-input100 validate-input m-b-20" data-validate="Digite la tarjeta profesional del medico">
						<input maxlength="32" required  class="input100" type="number" name="professional-card-medic" placeholder="Digite la tarjeta profesional del medico" value="<?php if ($mensaje=='correcto') {echo $tarjeta;} ?>">
						<span class="focus-input100"></span>
					</div>
	        <div class="wrap-input100 validate-input m-b-20" data-validate="Digite la especialidad del medico">
						<input maxlength="32" required maxlength="32" required class="input100" type="text" name="speciality-medic" placeholder="Digite la  especialidad del medico" value="<?php if ($mensaje=='correcto') {echo $especialidad;} ?>">
						<span class="focus-input100"></span>
					</div>
