...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="../help/css/style_medical_history.css">
  ...
  <body>
      ...
      <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
          ...
          <ul class="nav nav-pills ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="medical-history.php">Historia Clínica</a>
            </li>
            <li class="nav-item">
    ...
    <table class="table-crud table table-bordered">
      <thead class="thead-crud">
        <tr>
          <th scope="col">idHistoria</th>
          <th scope="col">estatura</th>
          <th scope="col">peso</th>
          <th scope="col">antecedentesFamiliares</th>
          <th scope="col">alergias</th>
          <th scope="col">enfermedadesPadecidas</th>
          <th scope="col">idPacienteFK</th>
          <th scope="col"><button type="button" class="btn btn-success" onclick="location.href='add_medical-history.php'">Agregar Nuevo</button></th>
        </tr>
      </thead>
			<tbody>
        <?php
        require_once('../models/clsHistoriaClinica.php');
        $objeto=new HistoriaClinica();
        $filas=$objeto->consultarTodos();
        if ($filas !=null){
          foreach ($filas as $fila) {
        ?>
        <tr>
          <td class="crud-text-blue"><?php echo $fila['idHistoria']; ?></td>
          <td class="crud-text-green"><?php echo $fila['estatura']; ?></td>
          <td class="crud-text-blue"><?php echo $fila['peso']; ?></td>
          <td class="crud-text-green"><?php echo $fila['antecedentesFamiliares']; ?></td>
          <td class="crud-text-blue"><?php echo $fila['alergias']; ?></td>
          <td class="crud-text-green"><?php echo $fila['enfermedadesPadecidas']; ?></td>
          <td class="crud-text-blue"><?php echo $fila['idPacienteFK']; ?></td>
          <td>
