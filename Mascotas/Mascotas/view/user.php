    ...
    <table class="table-crud table table-bordered">
      <thead class="thead-crud">
        <tr>
          ...
          <th scope="col">direccionUsuario</th>
          <th scope="col">passwordUsuario</th>
          <th scope="col">rolUsuario</th>
          <th scope="col">estadoUsuario</th>
          <th scope="col"><button type="button" class="btn btn-success" onclick="location.href='add_user.php'">Agregar Nuevo</button></th>
        </tr>
      </thead>
      <tbody>
        <?php
        ...
        ?>
        <tr>
          <td class="crud-text-blue"><?php echo $fila['idUsuario']; ?></td>
          <td class="crud-text-green"><?php echo $fila['nombreUsuario']; ?></td>
          <td class="crud-text-blue"><?php echo $fila['apellidoUsuario']; ?></td>
          <td class="crud-text-green"><?php echo $fila['correoUsuario']; ?></td>
          <td class="crud-text-blue"><?php echo $fila['telefonoUsuario']; ?></td>
          <td class="crud-text-green"><?php echo $fila['direccionUsuario']; ?></td>
          <td class="crud-text-blue"><?php echo $fila['passwordUsuario']; ?></td>
          <td class="crud-text-green"><?php echo $fila['rolUsuario']; ?></td>
          <td class="crud-text-blue"><?php echo $fila['estadoUsuario']; ?></td>
          <td>
            <div class="btn-group btn-group-crud" role="group" aria-label="Basic example">
              <button type="button" onclick="location.href='../controllers/ControlConsultarUsuario.php?Id=<?php echo $fila['idUsuario']; ?>'" class="btn btn-warning btn-crud">Editar</button>
              <button type="button" onclick="location.href='../controllers/controlEliminarUsuario.php?Id=<?php echo $fila['idUsuario']; ?>'" class="btn btn-danger btn-crud">Eliminar</button>
            </div>
          </td>
        </tr>
        <?php
